...
//        passwordTextInput.rightView = paddingForPasswordText
...
//        ])
        ...
        NSLayoutConstraint.activate([
            getQuizzesButton.topAnchor.constraint(equalTo: headerText.bottomAnchor, constant: 10),
            getQuizzesButton.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 30),
            getQuizzesButton.widthAnchor.constraint(equalTo: view.widthAnchor, constant: -60),
